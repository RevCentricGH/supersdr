...
## Browser automation approach (Steps 3-5)

Dispositions, contact stages, and triggers have no Apollo API or MCP endpoints — they are UI-only settings. This skill uses Hermes `browser_*` headless tools to automate the Apollo UI.
